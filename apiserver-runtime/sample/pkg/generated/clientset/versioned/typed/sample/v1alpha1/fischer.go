...
import (
	...
	v1alpha1 "github.com/vine-io/kes/apiserver-runtime/sample/pkg/apis/sample/v1alpha1"
	scheme "github.com/vine-io/kes/apiserver-runtime/sample/pkg/generated/clientset/versioned/scheme"
...
type FischerInterface interface {
	...
	UpdateStatus(ctx context.Context, fischer *v1alpha1.Fischer, opts v1.UpdateOptions) (*v1alpha1.Fischer, error)
...
func (c *fischers) UpdateStatus(ctx context.Context, fischer *v1alpha1.Fischer, opts v1.UpdateOptions) (result *v1alpha1.Fischer, err error) {
	result = &v1alpha1.Fischer{}
	err = c.client.Put().
		Resource("fischers").
		Name(fischer.Name).
