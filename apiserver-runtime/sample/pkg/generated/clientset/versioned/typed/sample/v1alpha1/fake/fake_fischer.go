...
func (c *FakeFischers) UpdateStatus(ctx context.Context, fischer *v1alpha1.Fischer, opts v1.UpdateOptions) (*v1alpha1.Fischer, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(fischersResource, "status", fischer), &v1alpha1.Fischer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Fischer), err
