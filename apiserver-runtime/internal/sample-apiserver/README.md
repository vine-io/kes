...
**Note:** go-get or vendor this package as `""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver`.
...
`sample-apiserver` is synced from https://github.com/kubernetes/kubernetes/blob/master/staging/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver.
...
```sh
go get -d ""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver
cd $GOPATH/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver  # assuming your GOPATH has just one entry
godep restore
```
...
`kubernetes/staging/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver` and its dependencies
