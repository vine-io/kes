...
mkdir -p ${goPath}/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver
cp -R . ${goPath}/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver

pushd ${goPath}/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver/vendor .
mv ${goPath}/src/""github.com/vine-io/kes/apiserver-runtime/internal/sample-apiserver/Godeps .
git add vendor
git add Godeps
