...
**Note:** go-get or vendor this package as `github.com/vine-io/kes/sample-apiserver`.
...
`sample-apiserver` is synced from https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/vine-io/kes/sample-apiserver.
...
`kubernetes/staging/src/github.com/vine-io/kes/sample-apiserver` and its dependencies
