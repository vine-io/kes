...
type Config struct {
	...
	// This is composed of generickeserver defaultAPIResourceConfig and those parsed from flags.
	// If not specify any in flags, then generickeserver will only enable defaultAPIResourceConfig.
...
// DrainedNotify returns a lifecycle signal of generickeserver already drained while shutting down.
