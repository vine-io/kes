...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FischerStatus) DeepCopyInto(out *FischerStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FischerStatus.
func (in *FischerStatus) DeepCopy() *FischerStatus {
	if in == nil {
		return nil
	}
	out := new(FischerStatus)
