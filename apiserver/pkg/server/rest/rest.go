...
func New(obj resource.Object) StorageProvider {
...
func NewWithStrategy(obj resource.Object, s Strategy) StorageProvider {
	return func(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.Storage, error) {
		gvr := obj.GetGroupVersionResource()
		return newStore(scheme, obj.New, obj.NewList, gvr, s, optsGetter, nil)
	}
...
func NewWithFn(obj resource.Object, fn StoreFn) StorageProvider {
	return func(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.Storage, error) {
		gvr := obj.GetGroupVersionResource()
		s := &DefaultStrategy{
			Object:         obj,
...
type SubResourceStorageFn func() (path string, parent resource.Object, request resource.Object, storage StorageProvider)
...
type ResourceStorageFn func() (request resource.Object, storage StorageProvider)
