...
import (
	...
	"github.com/vine-io/kes/apiserver/pkg/admission/plugin/banflunder"
	"github.com/vine-io/kes/apiserver/pkg/admission/wardleinitializer"
	"github.com/vine-io/kes/apiserver/pkg/apis/wardle/v1alpha1"
	"github.com/vine-io/kes/apiserver/pkg/apiserver"
	clientset "github.com/vine-io/kes/apiserver/pkg/generated/clientset/versioned"
	informers "github.com/vine-io/kes/apiserver/pkg/generated/informers/externalversions"
	sampleopenapi "github.com/vine-io/kes/apiserver/pkg/generated/openapi"
	...
	genericoptions "github.com/vine-io/kes/pkg/server/options"
...
func (o *WardleServerOptions) Config() (*apiserver.Config, error) {
	...
	o.RecommendedOptions.ExtraAdmissionInitializers = func(c *generickeserver.RecommendedConfig) ([]admission.PluginInitializer, error) {
	...
	serverConfig := generickeserver.NewRecommendedConfig(apiserver.Codecs)

	serverConfig.OpenAPIConfig = generickeserver.DefaultOpenAPIConfig(sampleopenapi.GetOpenAPIDefinitions, openapi.NewDefinitionNamer(apiserver.Scheme))
	serverConfig.OpenAPIConfig.Info.Title = "Wardle"
	serverConfig.OpenAPIConfig.Info.Version = "0.1"

	serverConfig.OpenAPIV3Config = generickeserver.DefaultOpenAPIV3Config(sampleopenapi.GetOpenAPIDefinitions, openapi.NewDefinitionNamer(apiserver.Scheme))
...
func (o WardleServerOptions) RunWardleServer(stopCh <-chan struct{}) error {
	...
	server.GenericAPIServer.AddPostStartHookOrDie("start-sample-server-informers", func(context generickeserver.PostStartHookContext) error {
